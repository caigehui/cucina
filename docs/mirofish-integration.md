...
```powershell
python scripts/mirofish_bridge.py seed --topic 'NVDA earnings simulation' --question '若毛利率下修,AI 供应链叙事如何变化?' --symbol NVDA --input output/tmp/nvda_seed.md --horizon '2 weeks'
```
...
```powershell
python scripts/mirofish_bridge.py import-report --run-dir output/simulations/2026-06-10_nvda-earnings-simulation --report C:\path\to\mirofish_report.md --as-of 2026-06-10
```
